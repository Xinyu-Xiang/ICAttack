export PYTHONPATH="/data/wxy/IoUattack:$PYTHONPATH"
# test lasher
...
# test rgbt234
CUDA_VISIBLE_DEVICES=2 NCCL_P2P_LEVEL=NVL python ./RGBT_workspace/test_rgbt_mgpus.py --script_name bat --dataset_name GTOT --yaml_name rgbt 
