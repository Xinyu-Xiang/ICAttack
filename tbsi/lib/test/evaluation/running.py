...
def run_sequence(seq: Sequence, tracker: Tracker, debug=False, num_gpu=8):
    ...
    def _results_exist():
        if seq.object_ids is None:
            ...
            return os.path.isfile(bbox_file) #false
        else:
    ...
    if debug:
        ...
        try:
            output = tracker.run_sequence(seq, debug=debug, run_id=tracker.run_id, name=tracker.parameter_name)#run_id=None
        except Exception as e: #here comes the question
            print(e)
            return
