class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = './SDSTrack'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = './SDSTrack/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = './SDSTrack/pretrained_networks'
